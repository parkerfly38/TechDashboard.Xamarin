    ...
    public class RestClient : TdWs.RestClient.TdWs_RestClient
    {
        ...
        public string GetDeviceID(string deviceName)
        {
            ...
            if (response.StatusCode != System.Net.HttpStatusCode.OK)
            {
                ...
                // App.sendException(new Exception(response.Content));
                App.sendException(new Exception(response.Content), "RestClient.cs.GetDeviceID");
            }
        ...
        public List<T> GetDataSync<T>(string filterType, string filterText)
        {
            ...
            try
            {
                ...
                if (response.StatusCode != System.Net.HttpStatusCode.OK && response.StatusCode != System.Net.HttpStatusCode.NotFound)
                {
                    //throw new Exception("Bad request");
                    //App.sendException(new Exception(response.Content));
                    App.sendException(new Exception(response.Content), "RestClient.cs.GetDataSync");
                }
            ...
            catch (Exception exception)
            {
                ...
                App.sendException(exception, string.Format("TechDashboard.RestClient.GetDataSync: FilterType={0}; FilterText={1}",
        ...
        public List<T> GetDataPostSync<T>(string filterType, string filterText)
        {
            ...
            {
                //throw new Exception("Bad request");
                App.sendException(new Exception(response.Content), "RestClient.cs.GetDataPostSync");
            }
        ...
        public bool UpdateTechnicianRecordSync(JT_Technician technician)
        {
            ...
            {
                App.sendException(ex, "TechDashboard.Data.UpdatTechnicianRecordSync");
            }
        ...
        public Rkl.Erp.Sage.Sage100.TableObjects.API_Results InsertTransactionImportDetailRecordSync(JT_TransactionImportDetail importDetail)
        {
            ...
            catch (Exception ex)
            {
                ...
                // dch rkl 12/07/2016 Log Error
                //ErrorReporting errorReporting = new ErrorReporting();
                App.sendException(ex, "TechDashboard.Data.RestClient");
