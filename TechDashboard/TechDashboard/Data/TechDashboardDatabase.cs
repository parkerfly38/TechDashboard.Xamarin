...
namespace TechDashboard.Data
{
    ...
    { 
        ...
        public TechDashboardDatabase()
        {
            ...
            //_dataConnectionType = GetApplicatioinSettings().ErpConnectionType;//ConnectionType.SData;

            //CreateGlobalTables();  puke
        }
        ...
        public void FillWorkTicketTable()
        {
            ...
            // dch rkl 01/20/2017
            FillLocalTable<JT_WorkTicketText>();
        }
        ...
        public void FillServiceEquipmentPartsTable()
        {
            ...
            for (int i = 0; i < workTickets.Count; i++)
            {
                if (workTickets[i].DtlRepairItemCode != null && !sb.ToString().Contains(workTickets[i].DtlRepairItemCode))
                {
                    if (i > 0)
                    {
                        sb.Append(" or ");
            ...
            FillLocalTable<JT_ServiceEquipmentParts>();
        }
