...
namespace TechDashboard.Data
{
    public partial class TechDashboardDatabase
    {
        ...
        protected void FillShipToAddressTable()
        {
            ...
            List<SO_SalesOrderHeader> salesOrderHeaders = _database.Table<SO_SalesOrderHeader>().GroupBy(soh => soh.CustomerNo).Select(grp => grp.First()).ToList();
            ...
            //bk - it's inarguably more efficient just to grab all the records
