...
namespace TechDashboard.ViewModels
{
    public class ExpensesEditPageViewModel
    {
        ...
        protected ObservableCollection<JT_MiscellaneousCodes> _expenseCategories;
        ...
        public ObservableCollection<JT_MiscellaneousCodes> ExpenseCategories
        {
        ...
        {
            _expenseCategories = new ObservableCollection<JT_MiscellaneousCodes>(App.Database.GetExpenseCategoriesWithDesc());
            //_expenseChargeCodes = new ObservableCollection<string>(App.Database.GetExpenseChargeCodes());
            _expenseChargeCodes = new ObservableCollection<string>(App.Database.GetExpenseChargeCodesWithDesc());
        }
